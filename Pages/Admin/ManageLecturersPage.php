...
require_once(ROOT_DIR . 'Presenters/Admin/ManageLecturersPresenter.php');
require_once(ROOT_DIR . 'Domain/Access/namespace.php');
require_once(ROOT_DIR . 'lib/Application/Attributes/namespace.php');

interface IManageLecturersPage extends IPageable, IActionPage
{
    /**
...
class ManageLecturersPage extends ActionPage implements IManageLecturersPage
{
    /**
     * @var \ManageLecturersPresenter
     */
    ...
    {
        $serviceFactory = new ManageLecturersServiceFactory();

        parent::__construct('ManageLecturers', 1);
        $groupRepository = new GroupRepository();
        $this->_presenter = new ManageLecturersPresenter(
            $this,
            new UserRepository(),
    ...
    {
        $this->Display('Admin/Users/manage_lecturers.tpl');
    }
    ...
    public function GetLecturerId()
    {
        return $this->GetForm(FormKeys::LECTURER_ID);
    }

    public function GetHireDate()
    {
        return $this->GetForm(FormKeys::LECTURER_HIRE_DATE);
    }

    public function GetPhoneNumber()
    {
        return $this->GetForm(FormKeys::LECTURER_PHONE_NUMBER);
    }
    ...
    public function ShowTemplateCSV($attributes)
    {
        ...
        $this->DisplayXlsx('Admin/Users/import_lecturer_template_csv.tpl', 'lecturers.xlsx');
    }
    ...
    public function ShowUserUpdate(User $user, $attributes)
    {
        ...
        $this->Set('User', $user);
        $this->Set('Attributes', $attributes);
        $this->Display('Admin/Users/lecturer-update.tpl');
    }
}
