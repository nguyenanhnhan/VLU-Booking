...
interface IManageVluersPage extends IPageable, IActionPage
{
     ...
     * @return int[]
     */
    public function GetDeletedStudentIds();
...
class ManageVluersPage extends ActionPage implements IManageVluersPage
{
    /**
     * @var \ManageVluersPresenter
     */
    ...
    {
        $serviceFactory = new ManageVluersServiceFactory();

        parent::__construct('ManageStudents', 1);
        $groupRepository = new GroupRepository();
        $this->_presenter = new ManageVluersPresenter(
            $this,
            new UserRepository(),
    ...
    {
        $this->Display('Admin/Users/manage_vluers.tpl');
    }
    ...
    public function ShowTemplateCSV($attributes)
    {
        ...
        $this->DisplayXlsx('Admin/Users/import_vluer_template_csv.tpl', 'vluers.xlsx');
    }
    ...
    public function ShowExportCsv()
    {
        $this->DisplayCsv('Admin/Users/vluers_csv.tpl', 'vluers.csv');
    }
    ...
    public function ShowUserUpdate(User $user, $attributes)
    {
        ...
        $this->Display('Admin/Users/vluer-update.tpl');
    }
}
